...
describe("Token contract", function () {
  ...
  describe("Burn", function(){
    it("Should burn tokens", async function () {
      ...
      await hardhatToken.burnToken(50);
      const burnBalance = await hardhatToken.balanceOf(
        nullAddress
      );
      expect(burnBalance).to.equal(50);
      ...
      // We use .connect(signer) to send a transaction from another account
      await hardhatToken.connect(addr1).burnToken(50);
      const burn2 = await hardhatToken.balanceOf(
        nullAddress
      );
      expect(burn2).to.equal(100);
